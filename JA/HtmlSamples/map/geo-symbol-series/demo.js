$(function () {
            ...
            var shapeDataSource = new $.ig.ShapeDataSource({
                shapefileSource: "http://jp.staging.igniteui.local/16-2/data-files/shapes/world_cities.shp",
                databaseSource: "http://jp.staging.igniteui.local/16-2/data-files/shapes/world_cities.dbf",
